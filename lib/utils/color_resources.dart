...
class ColorResources {
  static Color getPrimaryColor() {
    return Get.isDarkMode ? Color(0xFFFF74D9) : Color(0xFFE054B8);
  }

  static Color getPrimaryTextColor() {
    return Get.isDarkMode ? Color(0xFF34495E) : Color(0xFF2C3F50);
  }
  ...
  static Color getGreyColor() {
    return Get.isDarkMode ? Color(0xFFEBF1F1) : Color(0xFFBEC3C7);
  }
  ...
  ///#686868
  static const Color COLOR_PRIMARY = Color(0xFFC822FF);
