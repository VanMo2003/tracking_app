class AppConstant {
  ...
  static const String ADMIN =
      'https://goodhere-dev.oceantech.com.vn/api/v1/oauth/token';
  static const String BASE_URL = 'http://android-tracking.oceantech.com.vn';
  static const String LOGIN_URI = '/mita/oauth/token';
  static const String REGISTOR_URI = '/mita/public/sign';
  static const String GET_USER = '/mita/users/get-user-current';
  static const String LOG_OUT = '/mita/oauth/logout';
  static const String LOCK = '/mita/users/lock';
  static const String UPDATE_MYSELF = '/mita/users/update-myself';
  static const String UPDATE_USER = '/mita/users/update';
